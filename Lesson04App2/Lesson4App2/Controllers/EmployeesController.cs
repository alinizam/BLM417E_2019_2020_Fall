...
namespace Lesson4App2.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PersonelId,FirstName,LastName,Salary")] Employees employees)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonelId,FirstName,LastName,Salary")] Employees employees)
        {
